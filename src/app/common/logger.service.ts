...
export interface LogObject {
    ...
    hook?: 'constructor' | 'input-change' | 'pipe-transform' | 'ngOnChanges' | 'ngOnInit' | 'ngAfterViewInit' | 'ngAfterViewChecked' | 'ngAfterContentInit' | 'ngAfterContentChecked' |  'template-expression' | 'template-binding' | 'ngOnDestroy';
